...
RSpec.describe TestTrack::Remote::SplitConfig do
  ...
  let(:create_url) { "http://dummy:fakepassword@testtrack.dev/api/split_configs" }
  let(:destroy_url) { "http://dummy:fakepassword@testtrack.dev/api/split_configs/some_split" }
