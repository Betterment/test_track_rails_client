...
RSpec.describe TestTrackRails::NotificationJob do
  ...
  describe "#perform" do
    ...
    before do
      ...
      allow(TestTrackRails::Assignment).to receive(:create!).and_call_original
    ...
    it "sends test_track assignments" do
      ...
      expect(TestTrackRails::Assignment).to have_received(:create!).with(
